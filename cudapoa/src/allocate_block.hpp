...
public:
        ...
        , output_mask_(output_mask)
    {
        ...
        matrix_sequence_dimension_ = banded_alignment_ ? (batch_size.alignment_bandwidth + CUDAPOA_BANDED_MATRIX_RIGHT_PADDING) : batch_size.max_matrix_sequence_dimension;
