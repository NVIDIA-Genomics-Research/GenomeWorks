...
#define GW_POA_KERNELS_MAX_THREADS_PER_BLOCK 1024
                                      ...
                                      TraceT* traceback_d       = nullptr)
{
    ...
    else if (BM == BandMode::static_band_traceback || BM == BandMode::adaptive_band_traceback)
    {
    ...
    for (int32_t s = 1; s < num_sequences; s++)
    {
        ...
        else if (BM == BandMode::adaptive_band_traceback && static_band_width < CUDAPOA_MAX_ADAPTIVE_BAND_WIDTH)
        {
                 ...
                 const BatchConfig& batch_size)
{
    ...
    if (msa)
    {
        ...
        {
            generatePOAKernel<ScoreT, SizeT, TraceT, true, BandMode::static_band_traceback>
                <<<nblocks, TPB, 0, stream>>>(consensus_d,
                                              sequences_d,
                                              base_weights_d,
                                              sequence_lengths_d,
        ...
        {
            generatePOAKernel<ScoreT, SizeT, TraceT, true, BandMode::adaptive_band_traceback>
                <<<nblocks, TPB, 0, stream>>>(consensus_d,
                                              sequences_d,
                                              base_weights_d,
                                              sequence_lengths_d,
    ...
    else
    {
        ...
        {
            generatePOAKernel<ScoreT, SizeT, TraceT, false, BandMode::static_band_traceback>
                <<<nblocks, TPB, 0, stream>>>(consensus_d,
                                              sequences_d,
                                              base_weights_d,
                                              sequence_lengths_d,
        ...
        {
            generatePOAKernel<ScoreT, SizeT, TraceT, false, BandMode::adaptive_band_traceback>
                <<<nblocks, TPB, 0, stream>>>(consensus_d,
                                              sequences_d,
                                              base_weights_d,
                                              sequence_lengths_d,
