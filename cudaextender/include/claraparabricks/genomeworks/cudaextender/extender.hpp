...
public:
    ...
    virtual StatusType extend_async(int8_t* h_query, int32_t query_length,
    ...
    /// \return Status of the async extension launch
    virtual StatusType extend_async(int8_t* d_query, int32_t query_length,
...
std::unique_ptr<Extender> create_extender(int32_t* h_score_mat,
