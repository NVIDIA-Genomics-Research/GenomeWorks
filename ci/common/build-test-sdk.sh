...
if [ "$GPU_TEST" == '1' ]; then
  ...
  LD_LIBRARY_PATH=$LD_LIBRARY_PATH:$CGA_LIB_DIR ${LOCAL_BUILD_DIR}/install/benchmarks/cudaaligner/benchmark_cudaaligner_singlebatch --benchmark_filter="BM_SingleAlignment"
fi
