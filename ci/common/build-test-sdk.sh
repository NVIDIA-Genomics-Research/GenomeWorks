...
# configure
cmake $CMAKE_COMMON_VARIABLES ${CMAKE_BUILD_GPU} -Dclaragenomics_enable_tests=ON -Dclaragenomics_enable_benchmarks=ON -DCMAKE_INSTALL_PREFIX=${LOCAL_BUILD_DIR}/install ..
# Format files
make check-format
# build
