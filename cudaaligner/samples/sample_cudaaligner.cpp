...
using namespace genomeworks::genomeutils;
using namespace genomeworks::cudaaligner;
...
int main(int argc, char** argv)
{
    ...
    const std::size_t max_gpu_memory              = genomeworks::cudautils::find_largest_contiguous_device_memory_section();
    genomeworks::DefaultDeviceAllocator allocator = create_default_device_allocator(max_gpu_memory);
