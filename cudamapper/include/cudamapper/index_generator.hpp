...
/// \{
    ...
    class IndexGenerator {
        ...
        /// \brief returns mapping of internal read id that goes from 0 to number_of_reads-1 to length of the read
        /// returns mapping of internal read id that goes from 0 to number_of_reads-1 to length of the read
