...
TEST(TestCudamapperMatcher, CustomIndexFourReads)
{
    ...
    // read 2 - rep 3: 100
    // read 3 - rep 3: 80
    for (std::size_t query = 0; query < 130; ++query)
    { // block starts from 20*30 = 600
        for (std::size_t target = 0; target < 70; ++target)
        { // read 1 - no shift
        ...
        for (std::size_t target = 0; target < 100; ++target)
        { // read 2 - shift 70 due to read 1
        ...
        for (std::size_t target = 0; target < 80; ++target)
        { // read 8 - shift 170 due to read 1 and read 2
    ...
    // read 2 - rep 5: 100
    // read 3 - rep 5: 80
    for (std::size_t query = 0; query < 70; ++query)
    { // block starts from 600 + 130*250 = 33100
        for (std::size_t target = 0; target < 40; ++target)
        { // read 1 - no shift
        ...
        for (std::size_t target = 0; target < 80; ++target)
        { // read 8 - shift 140 due to read 1 and read 2
    ...
    // read 3 - rep 3: 80
    for (std::size_t query = 0; query < 70; ++query)
    { // block starts from 33100 + 70 * 220 = 48500
        for (std::size_t target = 0; target < 100; ++target)
        { // read 2 - no shift
        ...
        for (std::size_t target = 0; target < 80; ++target)
        { // read 3 - shift 100 due to read 2
    ...
    // read 1 - rep 4: 60
    // read 2 - rep 4: 100
    for (std::size_t query = 0; query < 60; ++query)
    { // block starts from 48500 + 70 * 180 = 61100
        for (std::size_t target = 0; target < 100; ++target)
        { // read 2 - no shift
    ...
    // read 2 - rep 5: 100
    // read 3 - rep 5: 80
    for (std::size_t query = 0; query < 40; ++query)
    { // block starts from 61100 + 60 * 100 = 67100
        for (std::size_t target = 0; target < 100; ++target)
        { // read 2 - no shift
    ...
    { // block starts from 67100 + 40 * 180 = 74300
        for (std::size_t target = 0; target < 80; ++target)
        { // read 3 - no shift
    ...
    // read 3 - rep 5: 80
    for (std::size_t query = 0; query < 100; ++query)
    { // block starts from 74300 + 100*800 = 82300
        for (std::size_t target = 0; target < 80; ++target)
        { // read 3 - no shift
