...
public:
    ...
    /// \param query_index A shared pointer to an index of sketch elements for the query sequences.
    /// \param target_index A shared pointer to an index of sketch elements for the target sequences.
