...
assembly_gfa_gt_filepath = os.path.join(current_dir, "data/sim_100_assembly_GT.gfa")
assembly_fa_gt_filepath = os.path.join(current_dir, "data/sim_100_assembly_GT.fa")
overlaps_on_assembly_gt_filepath = os.path.join(current_dir, "data/sim_100_overlaps_on_assembly_GT.paf")
polished_assembly_CPU_subgraph_gt_filepath = os.path.join(current_dir, "data/sim_100_polished_assembly_CPU_subgraph_GT.fa")
report_CPU_subgraph_gt_filepath = os.path.join(current_dir, "data/sim_100_polished_assembly_CPU_subgraph_GT.txt")
