...
from genomeworks.wrappers import wrappers
from genomeworks.utilities import utilities

# ground-truth files
current_dir = os.path.dirname(os.path.realpath(__file__))
reads_filepath = os.path.join(current_dir, "data/reads_saureus_150x_porechop.fasta.gz")
reference_filepath = os.path.join(current_dir, "data/saureus.fasta")
overlaps_gt_filepath = os.path.join(current_dir, "data/saureus_overlaps_GT.paf")
assembly_gfa_gt_filepath = os.path.join(current_dir, "data/saureus_assembly_GT.gfa")
assembly_fa_gt_filepath = os.path.join(current_dir, "data/saureus_assembly_GT.fa")
overlaps_on_assembly_gt_filepath = os.path.join(current_dir, "data/saureus_overlaps_on_assembly_GT.paf")
polished_assembly_CPU_subgraph_gt_filepath = os.path.join(current_dir, "data/saureus_polished_assembly_CPU_subgraph_GT.fa")
report_CPU_subgraph_gt_filepath = os.path.join(current_dir, "data/saureus_polished_assembly_CPU_subgraph_GT.txt")
